%{
/*	$Id: 8dd7ca,v 1.1 2008/08/27 10:42:15 fritsch Exp $	*/
...
/*
 * This file was copied from the OpenCVS-project (http://www.opencvs.org)
 *
 * Some parts are commented out but not removed! Some headers where inserted.
 *
 * Note for whitos.sh-users:
 * whitos.sh will report some warnings. But the warnings are nor fixed to keep
...
/* RD: yyerror-implementation replaced */
/*static int
...
cvs_date_parse(const char *p)
{
	...
	memset(&ftz, 0, sizeof(struct timeb));
