...
DlgRuleEditorBase::DlgRuleEditorBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxString controlCreationChoiceChoices[] = { wxT("Application"), wxT("AppFilter"), wxT("SFS"), wxT("Variable") };
	...
	controlRuleText1 = new wxStaticText( this, wxID_ANY, wxT("/ Rule:"), wxDefaultPosition, wxDefaultSize, 0 );
